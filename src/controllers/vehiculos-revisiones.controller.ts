...
export class VehiculosRevisionesController {
  ...
  async find(
    ...
    return this.vehiculosRepository.VehiculosRevisiones(id).find(filter);
  }
  ...
  async create(
    @param.path.string('id') id: typeof Vehiculos.prototype.idVehiculo,
    @requestBody({
      content: {
        'application/json': {
    ...
    return this.vehiculosRepository.VehiculosRevisiones(id).create(revisiones);
  }
  ...
  async patch(
    ...
    return this.vehiculosRepository.VehiculosRevisiones(id).patch(revisiones, where);
  }
  ...
  async delete(
    ...
    return this.vehiculosRepository.VehiculosRevisiones(id).delete(where);
  }
}
